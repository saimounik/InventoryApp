package in.paperwrk.inventoryapplication;
...
public class EditorActivity extends AppCompatActivity {
    ...
    private void insertBook() {
        ...
        String productName = bookName.getText().toString().trim();
        int productQuantity = Integer.parseInt(quantity.getText().toString().trim());
        int productPrice = Integer.parseInt(bookPrice.getText().toString().trim());
